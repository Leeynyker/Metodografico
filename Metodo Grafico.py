        ...
        for i in range(self.__numIne  - 2):
            ...
            if float(self.__Valores[i][0]) > 0 and float(self.__Valores[i][1]) > 0 :
                if self.__Valores[i][2] == "<=":
                    ptosf=((float(self.__Valores[i][3]) - x_vals*float(self.__Valores[i][0]))/float(self.__Valores[i][1]))
                    ptosi=0
                else:
                    ptosf=800
                    ptosi=((float(self.__Valores[i][3]) - x_vals*float(self.__Valores[i][0]))/float(self.__Valores[i][1]))
